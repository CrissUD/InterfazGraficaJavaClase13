...
public class LoginTemplate extends JFrame {
    ...
    public void crearObjetosDecoradores(){
        ...
        iFondo = new ImageIcon("Clase13/resources/img/fondo.png");
        iLogo = new ImageIcon("Clase13/resources/img/logo.png");
        iUsuario = new ImageIcon("Clase13/resources/img/usuario.png");
        iClave = new ImageIcon("Clase13/resources/img/clave.png");
        iPunto = new ImageIcon("Clase13/resources/img/punto.png");
        iFacebook = new ImageIcon("Clase13/resources/img/facebook.png");
        iTwitter = new ImageIcon("Clase13/resources/img/twitter.png");
        iYoutube = new ImageIcon("Clase13/resources/img/youtube.png");
        iSvg = new ImageIcon("Clase13/resources/img/imagen.png");
        iSvg2 = new ImageIcon("Clase13/resources/img/imagen2.png");
        iSvg3 = new ImageIcon("Clase13/resources/img/imagen3.png");
        iPunto2 = new ImageIcon("Clase13/resources/img/punto2.png");
    }
