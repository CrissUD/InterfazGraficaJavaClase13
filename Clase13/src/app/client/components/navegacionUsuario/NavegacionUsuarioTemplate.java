...
public class NavegacionUsuarioTemplate extends JPanel{
    ...
    public void crearObjetosDecoradores(){
        ...
        this.iIconoUsuario = new ImageIcon("Clase13/resources/img/usuario_navegacion.png");
        this.iInicio = new ImageIcon("Clase13/resources/img/inicio.png");
        this.iPerfil = new ImageIcon("Clase13/resources/img/perfil.png");
        this.iAmigos = new ImageIcon("Clase13/resources/img/amigos.png");
        this.iProductos = new ImageIcon("Clase13/resources/img/productos.png");
        this.iConfiguracion = new ImageIcon("Clase13/resources/img/configuracion.png");
        this.iCerrarSesion = new ImageIcon("Clase13/resources/img/salir.png");
    }
